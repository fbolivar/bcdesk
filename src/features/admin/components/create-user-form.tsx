    ...
    <div className="bg-[#1E293B] border border-[#334155] rounded-xl p-5">
      ...
      {created && (
        <div className="mb-4 px-4 py-3 rounded-lg bg-[#10B981]/10 border border-[#10B981]/20">
          ...
          <div className="text-xs text-[#F1F5F9] font-mono space-y-1">
            <p>Email: {created.email}</p>
            <p>Contraseña temporal: <span className="text-[#10B981]">{created.tempPassword}</span></p>
          </div>
          <button
            onClick={copyCreds}
            className="mt-3 flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-lg border border-[#334155] text-[#94A3B8] hover:text-[#F1F5F9] hover:border-[#3B82F6]/40 transition-colors"
          >
