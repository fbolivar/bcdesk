  ...
  return (
    <div className="bg-[#1E293B] border border-[#334155] rounded-xl p-5 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-sm font-semibold text-[#F1F5F9]">Aprobación: {state.workflowName}</h2>
      ...
      {state.status === 'pending' && state.canActNow && (
        <div className="border-t border-[#334155] pt-3 space-y-2">
          <p className="text-[11px] text-[#94A3B8]">
            Paso {state.currentStep}: <span className="text-[#F1F5F9]">{currentStepName}</span> — tu decisión:
          </p>
