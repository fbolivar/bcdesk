  ...
  return (
    <div className="space-y-4 max-w-2xl">
      <div className="flex items-center gap-3 flex-wrap">
        <h1 className="text-xl font-semibold flex items-center gap-2" style={{ color: '#0B2545' }}>🛠️ Control remoto (RustDesk)</h1>
      ...
      <div className="rounded-xl bg-white p-4" style={{ border: '1px solid #E6EBF2' }}>
        <p className="text-xs font-medium mb-2" style={{ color: '#5B6B7C' }}>📎 Comparte este link con el cliente:</p>
      ...
      {creds ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <p className="text-lg font-mono font-semibold" style={{ color: '#0B2545' }}>{creds.password || '—'}</p>
                {creds.password && (
                  <button onClick={() => copy(creds.password, 'pass')} title="Copiar contraseña"
                    className="p-1 rounded" style={{ color: copiedPass ? '#10B981' : '#5B6B7C' }}>
        ...
        <div className="rounded-xl bg-white p-8 text-center" style={{ border: '1px solid #E6EBF2' }}>
          ...
          <p className="text-sm font-medium mt-2" style={{ color: '#0B2545' }}>Esperando a que el cliente envíe su ID y contraseña…</p>
