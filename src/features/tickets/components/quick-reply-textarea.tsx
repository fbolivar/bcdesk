  ...
  return (
    <div className="space-y-2">
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        {visible.map(qr => (
          <button
            ...
            title={qr.content}
            className="text-[10px] px-2.5 py-1 rounded-full bg-[#334155] text-[#94A3B8] hover:bg-[#3B82F6]/20 hover:text-[#3B82F6] transition-colors max-w-[140px] truncate"
          >
            {qr.title}
          </button>
        ))}
      ...
      <textarea
        ...
        className="w-full px-3 py-2.5 rounded-lg bg-[#0F172A] border border-[#334155] text-[#F1F5F9] placeholder-[#64748B] focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6] transition-colors resize-none text-sm"
      />
    </div>
  )
}
