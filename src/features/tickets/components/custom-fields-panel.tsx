...
export function CustomFieldsPanel({ ticketId, fields, values }: Props) {
  ...
  return (
    <div className="bg-[#FFFFFF] border border-[#E6EBF2] rounded-xl p-4">
      <p className="text-xs font-semibold text-[#5B6B7C] mb-3">Campos adicionales</p>
          ...
          <div key={field.id}>
            ...
            {field.field_type === 'select' ? (
              ...
              <div className="flex gap-3">
                {['Sí', 'No'].map(opt => (
                  <label key={opt} className="flex items-center gap-1.5 cursor-pointer text-sm text-[#5B6B7C]">
