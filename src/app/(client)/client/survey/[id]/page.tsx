  ...
  if (existing) {
    return (
      <div className="max-w-lg mx-auto mt-20 text-center space-y-4">
        ...
        <h2 className="text-xl font-semibold text-[#0B2545]">¡Gracias por tu respuesta!</h2>
        <p className="text-[#5B6B7C]">Ya respondiste esta encuesta.</p>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-lg mx-auto mt-12 space-y-6">
      <div className="text-center">
        ...
        <h1 className="text-xl font-semibold text-[#0B2545]">{survey.name}</h1>
        {survey.description && <p className="text-sm text-[#5B6B7C] mt-1">{survey.description}</p>}
      </div>
