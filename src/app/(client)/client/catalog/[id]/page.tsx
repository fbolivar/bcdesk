...
export default async function CatalogItemRequestPage({ params }: Props) {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <Link href="/client/catalog" className="flex items-center gap-2 text-sm text-[#64748B] hover:text-[#1E293B] transition-colors">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold text-[#1E293B]">{item.name}</h1>
      ...
      <div className="bg-[#FFFFFF] border border-[#E6EBF2] rounded-xl p-5">
        <form action={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs text-[#64748B] mb-1">Título / Resumen *</label>
          ...
          <div>
            <label className="block text-xs text-[#64748B] mb-1">Descripción detallada *</label>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-[#E6EBF2]">
            <div className="text-xs text-[#64748B]">
              <span>SLA: </span>
              <span className="text-[#64748B]">{item.sla_hours} horas</span>
            </div>
            <button type="submit"
