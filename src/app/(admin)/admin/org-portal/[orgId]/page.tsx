      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-1 bg-[#FFFFFF] border border-[#E6EBF2] rounded-xl p-4">
          ...
          <form action={handleCreateTicket} className="space-y-2">
            ...
            <button type="submit"
              className="w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-[#3B82F6] hover:bg-[#2563EB] text-white text-xs font-medium transition-colors">
              <Plus size={12} /> Crear
            </button>
          </form>
        </div>
        ...
        <div className="col-span-2 bg-[#FFFFFF] border border-[#E6EBF2] rounded-xl overflow-hidden">
          ...
          <div className="divide-y divide-[#E6EBF2]/50">
            ...
            {ticketList.length === 0 && (
              <div className="px-4 py-8 text-center text-sm text-[#64748B]">Sin tickets</div>
            )}
          </div>
        </div>
      </div>
