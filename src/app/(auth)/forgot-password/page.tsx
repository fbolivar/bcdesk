...
export default function ForgotPasswordPage() {
  ...
  return (
    ...
    >
      <div className="mb-7">
        <h1 className="text-xl font-semibold" style={{ color: '#F0F4FF' }}>Recuperar contraseña</h1>
        <p className="text-sm mt-1" style={{ color: '#8B9BB4' }}>Te enviaremos un enlace para restablecerla</p>
      </div>
